...
`ignoreDifferenceError` - In case of error or segments difference, the getter will return null (_e.g., `/_not-found` could be at `/it/removed-page` and it would not have any params_)
...
## @nimpl/proxy-chain improvements

Now each chain element supports path rules for which it should work https://github.com/alexdln/nimpl-proxy-chain/issues/15
...
[ni-105 support multiple patterns](https://github.com/alexdln/nimpl-inio/pull/106)

[ni-98 support indent rules](https://github.com/alexdln/nimpl-inio/pull/99)

[ni-79 pagination and count on page logic](https://github.com/alexdln/nimpl-inio/pull/80)

[ni-56 add missings filter](https://github.com/alexdln/nimpl-inio/pull/75)

[ni-68 limit tool scope](https://github.com/alexdln/nimpl-inio/pull/69)
...
- [Describe nimpl-router](https://github.com/alexdln/nimpl-docs/issues/122);
- [Update proxy-chain docs](https://github.com/alexdln/nimpl-docs/issues/119);
- [Change link to nimpl/inio](https://github.com/alexdln/nimpl-docs/issues/117);
- [Update get-params docs](https://github.com/alexdln/nimpl-docs/issues/116);
